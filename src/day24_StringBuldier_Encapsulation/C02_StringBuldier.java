...
public class C02_StringBuldier {
    ...
    public static void main(String[] args) {
        ...
        sb.trimToSize();
        // >> bu method length'e gore kapasiteyi kirpar !! ( kullanilmayan fazlalik varsa )
        ...
        System.out.println(sb.toString().toUpperCase()); // JAVA ( >> toString methodu Stringe cevirir )
        ...
        // sb= sb.toString().toUpperCase();  >> data turu farkli atama olmaz
        ...
        StringBuilder sb2= new StringBuilder(sb.toString().toUpperCase());  // icerisine string yazilabilir
